...
<div class="w3-row-padding">
    <div class="w3-col m4 l3">
        <img src="https://res.cloudinary.com/drzjshskk/image/upload/e_sharpen:120/v1676716319/sdyxz/originals/loch-00_x3cshn.jpg"
            alt="Cover" width="100%">
        <div class="w3-container w3-center">
            <button type="button" class="w3-btn w3-white w3-hover-red w3-round" onclick="showBook('intro.md')">Prolog</button>
        </div>
    </div>
        <div class="w3-col m4 l3">
        <img src="https://res.cloudinary.com/drzjshskk/image/upload/e_contrast:85,q_auto:best/v1676662508/sdyxz/originals/ch01_qqa6or.jpg"
            alt="Bab 1" width="100%">
        <div class="w3-container w3-center">
            <button type="button" class="w3-btn w3-white w3-hover-red w3-round" onclick="showBook('bab1.md')">Bab 1</button>
        </div>
    </div>
        <div class="w3-col m4 l3">
        <img src="https://res.cloudinary.com/drzjshskk/image/upload/e_sharpen:120/v1676716319/sdyxz/originals/loch-00_x3cshn.jpg"
